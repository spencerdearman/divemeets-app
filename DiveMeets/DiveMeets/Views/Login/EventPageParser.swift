...
//    //                             Place  Name   NameLink  Team   Score   ScoreLink
//    @Published var eventPageData = [Int: (String, String, String, Double, String)]()
//
//    let getTextModel = GetTextAsyncModel()
//
//    func parseEventPage(html: String) async throws -> [Int: (String, String, String, Double, String)] {
...
struct EventPageHTMLParser: View {
    var body: some View {
