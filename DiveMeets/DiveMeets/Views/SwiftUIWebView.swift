    ...
    var body: some View {
        VStack {
            WebView(request: $request, parsedHTML: $parsedHTML,
                    parsedLinks: $parsedLinks, firstName: $firstName, lastName: $lastName, dmSearchSubmitted: $dmSearchSubmitted, linksParsed: $linksParsed)
        }
    }
}
...
struct WebView: UIViewRepresentable {
    ...
    func makeCoordinator() -> Coordinator {
        return Coordinator(html: $parsedHTML, links: $parsedLinks, firstName: $firstName, lastName: $lastName, dmSearchSubmitted: $dmSearchSubmitted, linksParsed: $linksParsed)
    }
    ...
    class Coordinator: NSObject, WKNavigationDelegate {
        ...
        init(html: Binding<String>, links: Binding<[String: String]>, firstName: Binding<String>, lastName: Binding<String>, dmSearchSubmitted: Binding<Bool>, linksParsed: Binding<Bool>) {
